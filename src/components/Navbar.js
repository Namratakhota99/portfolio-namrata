...
function Navbar() {
        ...
        <div>
            <nav className='fixed w-full z-20 top-0 bg-orange-100 bg-opacity-80'>
                ...
                {/* <FcBusinessContact className='w-5 h-5' /> */}
                    <h1 className='py-2 pl-3 pr-3 rounded md:p-0 hover:text-orange-600 text-violet-700'>Portfolio</h1>
    ...
    text-gray-500 rounded-lg md:hidden focus:ring-2 focus:ring-gray-200'>
        <IoMenu className='text-orange-400 text-lg'/>
    </button>
                    ...
                    <div className={`items-center justify-between w-full md:flex md:w-auto md:order-1 ${isOpen?'block':'hidden'}`}>
                        <ul className={`flex flex-col p-4 md:p-0 mt-4 text-xl border 
                    cursor-pointer border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 
